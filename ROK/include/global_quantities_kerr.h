...
/*----- ORBITAL QUANTITIES USED IN THE EVOLUTION ALGORITHM -----*/
  ...
  double R_p_o, COSTH_p_o;                         // Radial and polar coordinates employed in the angle variable evolution
  double GAMMA[4][4][4];                           // Christoffel symbols of the Kerr metric (associated with Boyer-Lindquist coordinates)
  double COS_PSI, COS_CHI;
...
/*----- Flags and Control Parameters -----*/
  char FLAG_CircOrb;                       // Flag that controls whether the orbit is circular
