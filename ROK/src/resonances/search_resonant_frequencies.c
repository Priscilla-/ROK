...
int search_resonant_frequencies(double e_res, double p_res, double th_inc_res, FILE *data)
{
...
/*-----Computing  New Orbital Parameters -----*/
    pez_to_ELCQ(FLAG_CircOrb,  p_res, e_res, th_inc_res, SPIN, &inclination, &r_peri,
...
/**----Resonant condition (notice that it is given in terms of the orbital frequencies) ----**/    
    ...
    if (resonance_condition <= Res_accuracy)
    {
        ...
        printf("  e= %4.6e   p = %4.12e  th_inc = %4.12e deg\n\n", e_res,  p_res, th_inc_res*180/PI);
        ...
        fprintf(data,"%d   %d  %4.6e  %4.10e   %4.12e   %4.12e   %4.12e %4.12e \n\n",
                Resorder[0], Resorder[1], OMEGA_r_res, OMEGA_th_res, e_res,  p_res, th_inc_res*180/PI, resonance_condition);
