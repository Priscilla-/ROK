...
/*----- Switch that selects the particular check of a given call -----*/
  switch(type)
  {
	...
	case 15:
	         /*----- Incompatibility between the flag 'FLAG_CircOrb" and the value of the Eccentricity -----*/
			 printf("  |--------------------------------------------------------------------------------\n  |\n");
			 printf("  | The flag 'FLAG_CircOrb' was set equals to 'y'.  However, the value of the\n");
