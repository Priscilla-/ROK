/*==============================================================================
   ...
   This routine returns the values of the constants of motion (E,Lz,Q).     
 
 In order to obtain (E,Lz,Q, iota) from (p,e,theta_inc), this routine uses a procedure   
 devised by the first time in a paper by W. Schmidt:

 W. Schmidt, "Celestial mechanics in Kerr spacetime", CQG 19, 2743–2764 (2002).
			    ...
			    double *energy, double *Lz, double *c_carter, double *q_carter)
{
  ...
  double cosi;                                          // Tangent  and cosinus of the other tilt angle (iota)
...
/*                                                                                       */
/*     eq_3 = Q - z_ [ Lz^2/(1-z_) + a^2 (1-E^2) ] = 0 ,                                 */
/*                                                                                       */
...
/*                                                                                       */
/*                                                                                       */
/*   Finally, one can find the other extremQl points (have a look at the C function      */
