...
int PN_ELzQdot(double *dEndt, double *dLzdt, double *dQdt, double *x, double r_BL, double cosTh_BL,double dpsidt, double dchidt,double dphidt, double dtaudt)
{
  double p, ecc,iota,M;
...
/*---- 
  ...
  *dEndt= -fcov[0]/u[0]; // dE/dtau * dtau/dt = dE/dt
