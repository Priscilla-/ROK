...
int evolution_OS(FILE *,FILE *,FILE *, double *x);
...
/*----- Reading and saving parameters of the Run -----*/
  reading_parameters();
...
/*----- Evolution using osculating formulation -----*/
  if(FLAG_OS=='y')
  {
   ...
   if(MAG_SF == 0)
    ...
    evolution_OS(data, dataf, dataflux, x);
...
//----Global variables initialization
  ...
  // else if
  //printf("Check evolution options");
