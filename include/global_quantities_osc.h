...
double LAMBDA[3];                  // Mino time, parameterized in different ways LAMBDA[1]=LAMBDA[t], LAMBDA[2]= LAMBDA[psi], LAMBDA[3] = LAMBDA[chi]
double dVRdR,dVTHdcth;             // derivatives of the polar and radial potential
